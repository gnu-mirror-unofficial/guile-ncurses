 ...
 (let ((stdscr (initscr)))
   (let* ((field1 (new-field 1 10 0 0 0 0))
     ...
     (let* (
       ...
       (refresh stdscr)
       ;;(sleep 1)
       (let ((ff1 (field-back field1))
	     (ff2 (field-back field2))
	     (ff3 (field-back field3))
	     (ff4 (field-back field4))
	     (ff5 (field-back field5))
	     (ff6 (field-back field6))
	     (ff7 (field-back field7)))
	 (unpost-form frm)
	 (endwin)
	 (newline)
	 ...
	 (format #t "field-back1:  ~32,'0b~%" ff1)
	 (format #t "field-back2:  ~32,'0b~%" ff2)
	 (format #t "field-back3:  ~32,'0b~%" ff3)
	 (format #t "field-back4:  ~32,'0b~%" ff4)
	 (format #t "field-back5:  ~32,'0b~%" ff5)
	 (format #t "field-back6:  ~32,'0b~%" ff6)
	 (format #t "field-back7:  ~32,'0b~%" ff7)
